...
\href{http://w3c.github.io/webcomponents/spec/custom/}{(w3c)}}{3.1. Custom Elements (w3c)}}\label{custom-elements-w3c}
...
steer the behavior of the element.
...
document object. Note that \texttt{shadowRoot} is marked as
...
indentation of code blocks and is typically out of syntax highlighting.
That's the time HTML templates come into play.

\subsection{\texorpdfstring{3.3. HTML Templates
\href{https://www.w3.org/TR/html5/scripting-1.html\#the-template-element}{(w3c)}}{3.3. HTML Templates (w3c)}}\label{html-templates-w3c}
