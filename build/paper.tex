...
Modularität nun auch nativ im Browser unterstützt
werden.{[}\^{}w3cWebComponent{]} Modularität als Designpattern ist in
der IT schon länger Standard um komplexe Systeme beherrschbar zu
...
des Gesamtsystems betrachtet werden sollen.{[}\^{}w3cHoudini{]}

\subsection{{[}\^{}w3cHoudini{]}:
https://drafts.css-houdini.org/}\label{w3choudini-httpsdrafts.css-houdini.org}
